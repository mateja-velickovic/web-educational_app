...
ALTER TABLE `t_activity`
  MODIFY `idActivite` int NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=20;
ALTER TABLE `t_registration`
  MODIFY `idRegistration` int NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=0;
ALTER TABLE `t_waiting`
  MODIFY `idWaiting` int NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=0;
ALTER TABLE `t_role`
  MODIFY `idRole` int NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=0;
ALTER TABLE `t_user`
