                ...
                foreach ($result as $row):
                    ...
                    <div class="activite">
                        <h2><?php echo $row['actName']; ?><a href=""><img class="info" src="resources/images/info.png"
                                    alt="Logo pour afficher la description de l'activité"></a></h2>
                        <p><img id="icon-info" src="resources/images/time.png"
                                alt="Logo pour représenter le temps/date"><?php echo $row['actDate']; ?></p>
